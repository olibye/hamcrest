...
public:
    ...
    all_of_t(const Matcher1& m1, const Matcher2& m2, const Matcher3& m3, const Matcher4& m4, const Matcher5& m5)
...
template <typename Matcher1, typename Matcher2, typename Matcher3>
all_of_t<typename Matcher1::argument_type> all_of(const Matcher1& m1, const Matcher2& m2, const Matcher3& m3)
    { return all_of_t<typename Matcher1::argument_type>(m1, m2, m3); }

template <typename Matcher1, typename Matcher2, typename Matcher3, typename Matcher4>
all_of_t<typename Matcher1::argument_type> all_of(const Matcher1& m1, const Matcher2& m2, const Matcher3& m3, const Matcher4& m4)
    { return all_of_t<typename Matcher1::argument_type>(m1, m2, m3, m4); }

template <typename Matcher1, typename Matcher2, typename Matcher3, typename Matcher4, typename Matcher5>
all_of_t<typename Matcher1::argument_type> all_of(const Matcher1& m1, const Matcher2& m2, const Matcher3& m3, const Matcher4& m4, const Matcher5& m5)
